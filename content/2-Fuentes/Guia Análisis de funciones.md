...
Eje $Y$: [[Guia Análisis de funciones#Puntos de corte|Ejemplos]]
Sustituimos la $x$:
...
Las soluciones nos dan los puntos de corte:
...
Después comprobamos si el punto corresponde a un máximo o a un mínimo.
